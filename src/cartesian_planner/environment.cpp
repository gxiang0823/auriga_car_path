...
constexpr double kSampleStep = 0.01;
...
bool Environment::CheckStaticCollision(const math::Box2d &rect) {
  ...
  // binary search：找到rect的前后两个vector迭代器
