...
public:
  ...
  VehicleParam() {
    ...
    radius = hypot(0.25 * length, 0.5 * width);//两个圆盘覆盖整辆车，圆盘半径为radius
    //两个中心点分别设置为整车长的0.75与0.25位置，r2x、f2x是该两个中心点到后轴距离
