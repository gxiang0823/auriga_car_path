...
struct CartesianPlannerConfig {
  ...
  /**
   * nominal velocity，期望速度
   */
  double dp_nominal_velocity = 0.5;

  /**
   * cost of obstacles, should be set larger to avoid collision with obstacles
   */
  double dp_w_obstacle = 1000000000000;

  /**
   * cost of target_point, the larger the weight the closer to the target point 
   */
  double dp_w_target_point = 10000;
   ...
   */
  double dp_w_lateral_velocity_change = 0.5;

  /**
   * longitudinal velocity cost, velocity to the nominal velocity
   */
  double dp_w_longitudinal_velocity_bias = 3.0;

  /**
   * Cost of longitudinal velocity change, ds/dt
   */
  double dp_w_longitudinal_velocity_change = 0.5;
   ...
   */
  double opti_varepsilon_tol = 1e-3;
